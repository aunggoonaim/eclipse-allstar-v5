...
Begin VB.Form frmEditor_MapProperties 
   ...
   Begin VB.Frame frmMaxSizes 
      ...
      Begin VB.TextBox txtMaxY 
         ...
         Width           =   495
      End
      Begin VB.Label lblRecommand 
         Alignment       =   2  'Center
         Caption         =   "Recommand : Max X,Y = 30"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   222
   ...
   Begin VB.Frame fraMapSettings 
      ...
      Begin VB.ComboBox cmbMoral 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmMapProperties.frx":003E
         Left            =   960
         List            =   "frmMapProperties.frx":004E
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Top             =   360
         Width           =   3135
