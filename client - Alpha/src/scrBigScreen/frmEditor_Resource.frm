...
Begin VB.Form frmEditor_Resource 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   120
      Width           =   6615
      Begin VB.HScrollBar scrlSuccess 
         Height          =   255
         Left            =   5040
         Max             =   100
         Min             =   1
         ...
         Width           =   1335
      End
      Begin VB.HScrollBar scrlPwrReq 
         Height          =   255
         Left            =   5040
         Max             =   255
         TabIndex        =   34
      ...
      Begin VB.Label lblSuccess 
         ...
         Width           =   1335
      End
      Begin VB.Label lblToolpowerReq 
         Caption         =   "Tool Power Requirement : 0"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   222
...
Private Sub scrlSuccess_Change()
    lblSuccess.Caption = scrlSuccess.Value & "%"
