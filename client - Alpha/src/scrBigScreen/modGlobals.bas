...
Public MinMapX As Long
Public MinMapY As Long
...
' Fps max
Public Fps_Max As Boolean
Public hasParty As Boolean
Public ShowMiniMap As Boolean

Public skillLV(1 To MAX_PLAYER_SPELLS) As Byte
Public skillEXP(1 To MAX_PLAYER_SPELLS) As Long
...
Public EXPBar_Width2 As Long
Public SKILLBar_Width As Long
...
Public DropFire(1 To MAX_FIREDROPS) As DropRec
