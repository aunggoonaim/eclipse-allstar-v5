...
Begin VB.Form frmEditor_Animation 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         Caption         =   "Layer 0 (แสดงใต้ผู้เล่น)"
         Height          =   195
         Left            =   120
         TabIndex        =   4
         Top             =   720
...
Private Sub scrlAlpha_Change()
    ...
    Animation(EditorIndex).Alpha = scrlAlpha.Value
...
Private Sub scrlFrameCount_Change(Index As Integer)
    ...
    lblFrameCount(Index).Caption = "พิกัดเฟรม : " & scrlFrameCount(Index).Value
...
Private Sub scrlLoopCount_Change(Index As Integer)
    ...
    lblLoopCount(Index).Caption = "วนรอบ : " & scrlLoopCount(Index).Value
...
Private Sub scrlLoopTime_Change(Index As Integer)
    ...
    lblLoopTime(Index).Caption = "เวลา/รอบ : " & scrlLoopTime(Index).Value
...
Private Sub scrlSprite_Change(Index As Integer)
    ...
    lblSprite(Index).Caption = "อนิเมชั่น : " & scrlSprite(Index).Value
