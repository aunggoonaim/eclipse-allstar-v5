...
Begin VB.Form frmGuildAdmin 
   ...
   Begin VB.Frame frameMainRanks 
      ...
      Begin VB.Frame frameranks 
         ...
         Begin VB.ListBox listAccess 
            Height          =   1425
            ItemData        =   "frmGuildAdmin.frx":1CFA
            Left            =   840
            List            =   "frmGuildAdmin.frx":1CFC
            TabIndex        =   26
            Top             =   480
            Width           =   3015
         End
   ...
   Begin VB.Frame frameMainoptions 
      ...
      Begin VB.ComboBox cmbColor 
         Height          =   315
         ItemData        =   "frmGuildAdmin.frx":1CFE
         Left            =   1320
         List            =   "frmGuildAdmin.frx":1D0E
         Style           =   2  'Dropdown List
         TabIndex        =   30
         Top             =   360
         Width           =   1815
...
Dim i As Integer
    ...
    If listusers.ListIndex = 0 Then
        ...
        Exit Sub
    End If
    cmduser.Caption = "บันทึกสมาชิค #" & listusers.ListIndex
